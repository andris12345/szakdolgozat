...
double GameUnit::getPrice() { return price; }
double GameUnit::getHp() { return hp; }
double GameUnit::getMaxHp() { return maxHp; }
int GameUnit::getTipus() { return tipus; }
double GameUnit::getDmg() { return dmg; }
int GameUnit::getRange() { return range; }
int GameUnit::getPos() { return poz; }
double GameUnit::getXp() { return xp; }
...
void GameUnit::setPrice(double _price) { price = _price; };
void GameUnit::setHp(double _hp) { hp = _hp; }
void GameUnit::setMaxHp(double _maxHp) { maxHp = _maxHp; }
void GameUnit::setDmg(double _dmg) { dmg = _dmg; }
void GameUnit::setRange(int _range) { range = _range; }
void GameUnit::setPos(int _pos) { poz = _pos; }
void GameUnit::setXp(double _xp) { xp = _xp; }
